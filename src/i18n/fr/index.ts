...
const fr = {
	...
	allowConnections: 'Changez les paramètres de votre serveur pour autoriser les connexions desde',
	...
	copy: 'Copier',
	couldntCheckForUpdates: 'Impossible de vérifier automatiquement la presence de mises à jour',
	couldntConnectToOllamaServer: 'Impossible de se connecter au serveur Ollama',
	creatingTunnel: 'Création dun tunnel',
	...
	noRecentModels: 'Aucun modèle utilisé récent',
	...
	numa: 'NUMA',
	ollama: 'Ollama',
	ollamaLibrary: 'Bibliothèque dOllama',
	...
	prompt: 'Invite',
	promptPlaceholder: 'Écrivez littéralement nimporte quoi',
	...
	run: 'Exécuter',
	reVerify: 'Revérifier',
	runtimeOptions: 'Options dexécution',
	save: 'Enregistrer',
	search: 'Rechercher',
	...
	sessions: 'Sessions',
	settings: 'Paramètres',
	somethingWentWrong: 'Désolé, quelque chose sest mal passé',
	stop: 'Séquence darrêt',
	...
	you: 'Vous',
	copiedNotPrivate: 'Contenu copié, mais votre connexion nest pas privée',
	notCopiedNotPrivate: 'Impossible de copier le contenu. La connexion nest pas privée',
	importSuccess: 'Importation réussie',
	importError: "Échec de l'importation",
	deleteSuccess: 'Supprimé avec succès',
	serversDescription: 'Connexions, filtres de modèles et libellés',
	preferencesDescription: 'Langue, thème, modèles utilisés récemment, etc.',
	sessionsDescription:
		'Historique complet des sessions, pièces jointes et paramètres de modèles personnalisés',
	knowledgeDescription: 'Base de connaissances complète',
